            ...
            <div className="px-4 py-8">
                ...
                <div className="flex h-full flex-1 flex-col gap-4 rounded-sm">
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
                        ...
                        <StatCard
                            mainValue={driver.championshipsCount || 0}
                            subValue={driver.seasons}
                            label="Championships"
                        />
                        <StatCard mainValue={driver.races || 0} label="Races" />
                        <StatCard
                            mainValue={driver.wins || 0}
                                ...
                                data={[
                                    ...
                                    },
                                    {
                                        ...
                                        value: driver.info.lastRace && (
                                            <Link
                                                href={`/races/${driver.info.lastRace.id}`}
                                                className="hover:text-primary flex items-center gap-2"
                                            >
                                    ...
                                    },
                                    {
                                        ...
                                        value: driver.info.withoutPosition > 0 && (
                                            <>{driver.info.withoutPosition}</>
                                        ),
                                    },
                                    {
