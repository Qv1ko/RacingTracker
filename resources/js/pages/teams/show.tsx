            ...
            <div className="px-4 py-8">
                ...
                <div className="flex h-full flex-1 flex-col gap-4 rounded-sm">
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
                        ...
                        <StatCard
                            mainValue={team.championshipsCount || 0}
                            subValue={team.seasons}
                            label="Championships"
                        />
                                ...
                                data={[
                                    ...
                                    },
                                    {
                                        ...
                                        value: team.info.lastRace && (
                                            <Link
                                                href={`/races/${team.info.lastRace.id}`}
                                                className="hover:text-primary flex items-center gap-2"
                                            >
                                    ...
                                    },
                                    {
                                        ...
                                        value: team.info.withoutPosition > 0 && (
                                            <>{team.info.withoutPosition}</>
                                        ),
                                    },
                                    {
                                            ...
                                            {drivers.map(
                                                (driver, index) =>
                                                    driver && (
                                                        <div
                                                            key={`driver-${index}`}
                                                            className="w-auto rounded-sm border px-4 py-2"
                                                        >
                                                            <Link
