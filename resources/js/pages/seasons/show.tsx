                        ...
                        data={[
                            ...
                            },
                            {
                                ...
                                value: season.info.lastRace && (
                                    <Link
                                        href={`/races/${season.info.lastRace.id}`}
                                        className="hover:text-primary flex items-center gap-2"
                                    >
                            ...
                            },
                            {
                                ...
                                value: season.info.championDriver && (
                                    ...
                                    >
                                        <FlagIcon
                                            nationality={
                                                season.info.championDriver.nationality
                                                    ? season.info.championDriver.nationality
                                                    : "unkown"
                                            }
                                            size={16}
                            ...
                            },
                            {
                                ...
                                value: season.info.championTeam && (
                                    ...
                                    >
                                        <FlagIcon
                                            nationality={
                                                season.info.championTeam.nationality
                                                    ? season.info.championTeam.nationality
                                                    : "unkown"
                                            }
                                            size={16}
                            ...
                            {
                                key: "Most podiums",
                                value: season.info.mostPodiums &&
                                    season.info.mostPodiums.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
                            ...
                            },
                            {
                                ...
                                value: season.info.mostWithoutPosition &&
                                    season.info.mostWithoutPosition.length > 0 && (
                                        <div className="flex flex-wrap gap-2">
